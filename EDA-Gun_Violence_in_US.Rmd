...
Read the dataset:
```{r read, cache = TRUE, results = FALSE}
...
Clearly there are missing data from 2013, and 2018 isn't complete yet. Let's drop these two years. Let's also separate the "battery" or "homicide" incidents from suicides. 
```{r}
